...
(cl:defmethod cl:initialize-instance :after ((m <AveragingFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AveragingFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_actionlib-msg:<AveragingFeedback> is deprecated: use learning_actionlib-msg:AveragingFeedback instead.")))

(cl:ensure-generic-function 'sample-val :lambda-list '(m))
(cl:defmethod sample-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_actionlib-msg:sample-val is deprecated.  Use learning_actionlib-msg:sample instead.")
  (sample m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_actionlib-msg:data-val is deprecated.  Use learning_actionlib-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'mean-val :lambda-list '(m))
(cl:defmethod mean-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_actionlib-msg:mean-val is deprecated.  Use learning_actionlib-msg:mean instead.")
  (mean m))

(cl:ensure-generic-function 'std_dev-val :lambda-list '(m))
(cl:defmethod std_dev-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_actionlib-msg:std_dev-val is deprecated.  Use learning_actionlib-msg:std_dev instead.")
  (std_dev m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AveragingFeedback>)))
  ...
  "learning_actionlib/AveragingFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AveragingFeedback)))
  "Returns string type for a message object of type 'AveragingFeedback"
  "learning_actionlib/AveragingFeedback")
