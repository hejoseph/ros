...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joseph/workspace_catkin/src/install/${idir}'.  Ask the maintainer 'joseph <joseph@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/joseph/workspace_catkin/src/install/lib;/home/joseph/workspace_catkin/devel/lib;/home/joseph/catkin_ws_cpp/devel/lib;/opt/ros/indigo/lib)
