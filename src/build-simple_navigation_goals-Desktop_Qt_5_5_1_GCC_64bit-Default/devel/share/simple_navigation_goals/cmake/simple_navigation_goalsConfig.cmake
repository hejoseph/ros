...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/joseph/workspace_catkin/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/joseph/workspace_catkin/src/build-simple_navigation_goals-Desktop_Qt_5_5_1_GCC_64bit-Default/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'joseph <joseph@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joseph/workspace_catkin/src/simple_navigation_goals/${idir}'.  Ask the maintainer 'joseph <joseph@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/joseph/workspace_catkin/src/build-simple_navigation_goals-Desktop_Qt_5_5_1_GCC_64bit-Default/devel/lib;/home/joseph/workspace_catkin/devel/lib;/home/joseph/catkin_ws_cpp/devel/lib;/opt/ros/indigo/lib)
