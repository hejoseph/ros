...
cd "/home/joseph/workspace_catkin/src/rosbridge_suite/rosapi"
...
/usr/bin/env \
    ...
    build --build-base "/home/joseph/workspace_catkin/build-src-Desktop_Qt_5_5_1_GCC_64bit-Default/rosbridge_suite/rosapi" \
    install \
    $DESTDIR_ARG \
